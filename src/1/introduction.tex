...
% IR Formulation
At a high level, tackling the problem of ``information overload'' is captured by a simple analogy: how exactly \emph{does} one find a needle in a haystack?
...
A piece of hay is certainly not a needle, for example, but is a pin sufficiently similar?
Will any needle do, or is there specific criteria to satisfy?
...
To date, the most successful approaches to large-scale information processing leverage human-provided descriptions to achieve robust representations of content.
Building computational systems on top of this data simplifies the problem greatly, and good progress has been made toward the development of useful applications.
...
First, human-provided information commonly used in such systems ---clicks, likes, views or shares--- are easily captured as a natural by-product of the typical user interaction paradigm.
...
% Research goal
Synthesizing these observations, the goal of this study is the exploration of deep learning methods as a general approach to the design of computer audition systems for music applications.
More specifically, the proposed research method proceeds thusly:
first, it is necessary to assess why progress in content-based music informatics may have stalled, and, in doing so, identify possible deficiencies in this methodology;
having built an understanding, standard approaches to music signal processing are reformulated in the language and concepts of deep learning, and subsequently applied to classic music informatics problems;
...
Alternatively, the other approach attempts to determine whether or not a model makes observations on par with other competent agents, forming the premise of Alan Turing's test for intelligence.
