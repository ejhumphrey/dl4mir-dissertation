...
Reassessed common practice and identified three possible deficiencies worth addressing:
...
After reviewing the history and fundamental components of deep learning, this work shifted focus to explore these methods directly.
...
Such a representation is also advantageous from a data collection, correction, and validation standpoints, significantly reducing the degree of pre-requisite skill necessary to contribute annotations.
