...
there is a great deal to be gained by finding ways to deploy systems as a means of facilitating data collection.
Traditionally, the process of annotating music for curating ground truth is achieved entirely by manual means, and less-than-perfect machines can be leveraged to greatly accelerate this daunting task.
