...
\subsection{k-Neighbors Classification}
...
Higher noise-floor for PCA-LDA model, indicating everything is bunched up.
Some unlikely confusions, such as cello and tuba; others it doesn't know what to do with, like bass clarinet.
Some confusions seem unavoidable, even in the NLSE model, such as french horn (ho) and trombone (tp).
Both appear to capture some element of pitch height, based on the confusions not made.
