...
\item How does the set of instrument considered impact the resulting embedding?
...
\begin{table*}[h]
\begin{center}
\caption{Average Precision - micro resulting from k-Neighbors classification.}
\begin{tabular}{rrrrr}
\hline
model \textbackslash config &    c5 &    c8 &   c12 &   c24 \\
\hline
 0    & 98.24 & 95.96 & 93.3  & 80.34 \\
 0.25 & 98.36 & 96.18 & 93.75 & 79.81 \\
 0.5  & 97.84 & 95.64 & 92.98 & 76.65 \\
\hline
\end{tabular}
\label{tab:things}
\end{center}
