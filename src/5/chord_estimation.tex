...
Whereas this can be mitigated with pseudo-counting \cite{?} ---setting a heuristically determined, non-zero lower bound--- the class prior here is computed by counting each observation toward the same quality in all roots.
