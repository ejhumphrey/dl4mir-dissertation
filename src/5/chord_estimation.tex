...
Table \ref{tab:algo_vs_algo} contains the micro-recall statistics when comparing the algorithmic estimations against each other, as well as the best track-wise match between either and the reference.
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{test_TREQOWO149E370718B_annotations}
\includegraphics[width=\textwidth]{test_TREQOWO149E370718B_legend}
