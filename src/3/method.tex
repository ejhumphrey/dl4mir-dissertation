...
% Foundations of computer science and computational mathematics
Computational foundations date back thousands of years, but the story of modern computer science begins in the 20th century.
1703 Leibnitz
1854 Boolean Alegebra

% Info theory & electrical engineering
Claude Shannon's \emph{master's} thesis in 1937
Building on Boolean Logic
Electro-mechanical computation

% Machine computing & cybernetics
Alan Turing, Universal Turing machine
Norbert Wiener, Cybernetics
von Neumann, computational design and implementations

% Develop machines capable of modeling logic, and thus decision making processes.


\subsubsection{Perceptrons}
\label{subsubsec:perceptrons}
One particular model of interest
Pitts and McCulloch, 1943, binary inputs and outputs for symbolic logic.
Donand Hebb, of ``Hebbian Learning'' fame, generalized this to continuous valued inputs in 1949
Rosenblatt, built electro mechanical things
...
Learning algorithm, error propagation

\begin{figure}
\begin{centering}
\includegraphics[width=\textwidth]{linsep}
\caption{Linearly separable data classified with by a perceptron.}
\label{fig:linsep}
\end{centering}
\end{figure}
...
Minsky, Papert punched holes in it, XOR / NXOR.
Perceptron can only solve linearly separable problems.
Cascade of operations, was known at the time.
...
% Other problems
Vanishing gradient, data hungry, slow.

% Over-hyped
Rosenblatt ran his mouth.

% Ahead of the times
Theory preceded technological capacity.

% Result
AI Winter, things got bad.
