...
\subsection{Origins (before 1980)}
...
Despite widespread pessimism toward neural computing, a select few would persevere through this ``AI Winter'', and continue research on neural networks.
...
At the highest level, deep learning is merely an approach to nonlinear system design that combines high level function design with numerical optimzation in an effort to model some desired
