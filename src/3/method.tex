...
% Radial Basis
The other common approach to classification in neural networks is to find the nearest neighbor, centroid, or template to a given output, given some distance function.
