...
\section{History of Whitefield's Crowds}
\label{sec:voice}
...
Pudding chocolate bar caramels toffee cookie jelly-o candy canes tiramisu tart \ac{tcap}. 
...
\begin{figure}[h]
\centering
\includegraphics[width=.6\textwidth]{pink_muffin.png}
...
Muffin dragée caramels sweet pudding danish bonbon jelly-o \gls{chula chips}. 
Dessert chocolate bar marzipan. 
Tiramisu cheesecake caramels cake lemon drops. Icing pastry lollipop marshmallow jujubes.
Gingerbread carrot cake marzipan soufflé halvah. Bear claw cheesecake toffee pie donut. 
